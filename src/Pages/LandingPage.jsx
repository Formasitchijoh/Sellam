      ...
      <div className="max-w-screen-2xl  xl:bg-teal-50 xl:flex xl:mx-auto h-screen">
        ...
        <div className=" absolute xl:mt-5  xl:bg-teal-50 xl:py-10 bottom-0 w-full xl:w-1/2  h-1/2 xl:h-full  opacity-90 bg-teal-50">
          <div className=" bg-blue-50 mt-20  xl:px-3 mx-5 xl:w-full xl:mt-20 xl:h-1/2 xl:mx-5 flex flex-col justify-center items-center h-1/4">
            ...
            <p className=" hidden xl:block  font-sans ">
              Sellam is a group of young and dynamic individuals who are tyring to revolutionalize the buying process <br /> by making the process of finding and ordering good seamlessly easy and enjoyable
            </p>
          ...
          <div className="w-full flex justify-around  mt-5 items-center">
            <button className="w-1/4 xl:w-1/5 h-10 bg-green-900 rounded-lg text-white text-lg uppercase">
              <Link to="/ProductItem">Buyer</Link>
            </button>
            <button className="w-1/4 xl:w-1/5 h-10 bg-green-900 rounded-lg text-white text-lg uppercase ">
              {" "}
              <Link to="/LoginPage">Vendor</Link>
            </button>
          </div>
        </div>
      </div>
