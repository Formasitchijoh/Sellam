  ...
  return (
    <>
      ...
      <div class="bg-gray-300 m-auto w-4/5  md:w-2/3 xl:w-1/3">
        ...
        <div class="bg-white rounded-3xl px-4 w-full">{product.img}</div>
        <div class="flex flex-row mt-4 bg-gray-200 justify-between">
          <p class="uppercase font-semibold text-lg">{product.pname}</p>

          <p class=" my-6 mx-18p text-lg">

            price: <span class="font-semibold ">CFA </span>
            <span class="font-semibold text-red-700 line-through">{product.price}</span>
          </p>
          <p class=" my-6 mx-18p text-lg">
            <span class="font-semibold ">CFA </span>
            <span class="font-semibold text-green-700">{product.discountPrice} </span>
          </p>
